...
return helium(function(param, view)
	playProps.onRelease = function() CurrentWorld = Worlds.gamePlay end
	-- loadProps
	-- settingProps.onClick = param.switch
	exitProps.onRelease = function() love.event.quit() end
